  ...
  return (
    <form style={{ marginBottom: 20 }}>
      ...
      <input
        ...
        onChange={handleClientChange}
        style={{ width: "48%", marginRight: "4%", marginBottom: 6 }}
      />
      <input
        type="text"
        name="state"
      ...
      <label style={{ display: "block", marginBottom: 6 }}>
        ...
        <select
          name="projectCode"
          value={data.project.projectCode || "LD"}
          onChange={handleProjectChange}
          style={{ marginLeft: 10 }}
        >
          <option value="LD">LD (Leads Digital)</option>
          <option value="LTC">LTC (Leads To Company)</option>
        </select>
      </label>
      ...
      <label style={{ display: "block", marginBottom: 6 }}>
        ...
        <select
          name="projectType"
          value={data.project.projectType || "OvP"}
          onChange={handleProjectChange}
          style={{ marginLeft: 10 }}
        >
